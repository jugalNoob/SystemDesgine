...
“Availability is ensured by replicating Kafka partitions and deploying 
multiple web servers behind a load balancer. Even if one server or broker fails, the
 system continues to respond to users.”